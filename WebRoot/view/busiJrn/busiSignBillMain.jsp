...
<body>
	...
	<div id="view_custInfo_updCustInfo_updForm_div" title="客户签单"
		class="easyui-dialog"
		data-options="closed:true,draggable:true,border:false,iconCls:'icon-edit',modal:true"
		style="width: 580px;height: 300px;"></div>
	<script type="text/javascript">
		...
		var editCustInfo = function(cusId) {
			var str = '${pageContext.request.contextPath }/busiJrn/findCustInfoByPrimaryKey.do?cusId='
					+ cusId;
