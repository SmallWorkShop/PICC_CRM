			...
			<table class="zzTable" style="width: 530px;text-align: center;">
				...
				<c:forEach var="connJrnL" items="${lConnJrn }">
					...
					<tr>
						...
						<td class="zzTd2"><c:if test="${connJrnL.sts eq '1' }">1-已联系</c:if>
							<c:if test="${connJrnL.sts eq '0' }">0-未联系</c:if></td>
				...
				<tr id="connJrn_addRow" style="visibility:hidden;">
					...
					<td class="zzTd2"><select id="connJrn_sts"
						class="easyui-combobox" data-options="value:'1'" size="6">
								...
								function(r) {
									if (r) {
										$
												.ajax({
													type : 'post',
													url : '${pageContext.request.contextPath }/connJrn/addConnJrn.do',
													dataType : 'text',
													data : {
														'cusId' : '${cusId }',
														'connNum' : $(
													...
													success : function(xmlq) {
														...
														parent
																.$(
																		'#view_connJrn_connrnMainPage_connEdit')
																.dialog(
																		'refresh');
													},
